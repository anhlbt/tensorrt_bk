...
from yolov5_trt import plot_one_box, increment_path, from_x1y1x2y2_to_yolo
...
if __name__ == "__main__":
    ...
    parser.add_argument('--weights', type=str,
                        default='build/yolov5s.engine', help='model.engine path')
    parser.add_argument('--lib', type=str,
                        default='build/libmyplugins.so', help='lib path(s)')
